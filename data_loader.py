...
def load_job() -> pd.DataFrame:
    ...
    - Menambah kolom 'has_restriction' untuk BQ 9.
    """
...
def load_glints() -> pd.DataFrame:
    ...
    - Menambah kolom 'salary_median', 'kota_singkat', 'sistem_kerja_label'.
    """
...
def split_skills(series: pd.Series) -> pd.Series:
    ...
    Returns: pd.Series berisi satu skill per baris (sudah di-strip dan di-lower-case).
    """
    exploded = (
        series.dropna()
        .astype(str)
